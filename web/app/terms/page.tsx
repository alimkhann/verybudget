...
const termsDict = {
    ...
    ru: {
        ...
        intro: 'Эти условия описывают правила пользования сайтом VeryBudget и участия в списке ожидания. Оставляя email, вы соглашаетесь получать новости о продукте, приглашения в бету и информацию о запуске. Отписаться можно в любой момент.',
        useOfSite: 'Правила пользования',
        useOfSite1: 'Не пытайтесь ломать, атаковать или мешать работе сайта.',
        useOfSite2: 'Контент предоставляется «как есть», без гарантий.',
        waitlist: 'Список ожидания',
        waitlistDesc: 'Запись в список не гарантирует доступ или точные сроки запуска.',
        intellectualProperty: 'Интеллектуальная собственность',
        intellectualPropertyDesc: 'Все товарные знаки, логотипы и материалы принадлежат VeryBudget.',
        limitationOfLiability: 'Ограничение ответственности',
        limitationOfLiabilityDesc: 'В пределах, разрешённых законом, VeryBudget не несёт ответственность за косвенные или случайные убытки при использовании сайта.',
        contact: 'Контакты',
